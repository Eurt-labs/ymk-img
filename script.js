...
function resizeCanvas() {
  if (window.innerWidth < 600) {
    ...
    c.height = Math.max(window.innerHeight * 0.55, 320);
  } else {
    c.width = window.innerWidth;
...
Y = 6.3;
  ...
  setInterval(function () {
    ...
    // Draw the birthday message centered in the heart
    var message = "Happy Birthday Srishti";
    a.save();
    a.font = "bold 48px Arial";
    a.textAlign = "center";
    ...
    a.fillText(message, textX, textY);
    a.lineWidth = 2;
    a.strokeText(message, textX, textY);
    a.restore();
